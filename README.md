...
- 💼 Currently working as a **CRM Developer at Systems Limited - Egypt**  
- 💡 Passionate about building robust **Dynamics 365** and **.NET Core** solutions for business transformation.  
- 🌍 Contributed to high-impact projects like the **RTA CRM System (Dubai)** and the **IIS (Abu Dhabi)**.
...
### 💼 CRM Dynamics 365
- 🔧 Customization: Entities, Forms, Views, Business Rules, **Dataverse**  
- ⚙️ **Plugins**, **Custom Workflows**, Actions, Power Automate  
- 🧠 JavaScript for client-side scripting, **Xrm ToolBox**  
- 🔗 Integration with REST APIs & Webhooks  
- 🛡️ Security roles, user management, and Dataverse data model  

### 🖥️ .NET Core & Backend Development
- 🌐 **ASP.NET Core Web API** for secure CRM integration  
- 🗃️ Entity Framework Core, **SQL Server** (Performance Optimization)  
- 🧩 C#, Middleware, Dependency Injection  
- 🔐 JWT Authentication, **Integration with third-party APIs**  

### 🛠️ Tools & Other Technologies
- 📁 Git & GitHub  
- 🧰 Visual Studio, **SSMS**, Postman  
- 🌐 HTML, CSS, JavaScript (Foundational Frontend)  
